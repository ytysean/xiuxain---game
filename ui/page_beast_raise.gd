...
func _建_饲灵() -> void:
	...
	嗜.modulate.a = 0.0
	嗜.create_tween().tween_property(嗜, "modulate:a", 1.0, 0.25)
	...
	求嗜.modulate.a = 0.0
	求嗜.create_tween().tween_property(求嗜, "modulate:a", 1.0, 0.25)
	...
	切嗜.modulate.a = 0.0
	切嗜.create_tween().tween_property(切嗜, "modulate:a", 1.0, 0.25)
	...
	鞭.modulate.a = 0.0
	鞭.create_tween().tween_property(鞭, "modulate:a", 1.0, 0.25)
	...
	求鞭.modulate.a = 0.0
	求鞭.create_tween().tween_property(求鞭, "modulate:a", 1.0, 0.25)
	...
	切鞭.modulate.a = 0.0
	切鞭.create_tween().tween_property(切鞭, "modulate:a", 1.0, 0.25)
