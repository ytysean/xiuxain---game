...
# 设计要点（按确认修订）：
#  · 灵兽「无适配道途」；改由「随机天赋」关联 灵根/道途（如某白虎天赋=冰灵根功法伤害+
...
# 灵兽类型（S1 P0 落地：攻伐/防御/辅助三类型，对应道途适配加成）
...
# 类型→适配道途（对齐项目实际 7 道途；部分旧方案道途名已迁移，不复用旧槽位）
...
# 全品阶灵兽名录（文档 V2 七阶 39 种）；无"适配道途"，契合度改由「随机天赋」体现
const 灵兽种类 := [
	# 凡阶
	{"名": "青纹狼", "品阶": "fan_jie"},
	{"名": "灵尾兔", "品阶": "fan_jie"},
...
# 随机天赋池：关联 灵根 或 道途，决定与弟子的契合度（见 disciple.灵兽联动）
const 天赋池 := [
	...
	{"类型": "道途", "关联": "道修", "效果": "道修破法穿透+12%"},
	{"类型": "道途", "关联": "体修", "效果": "体修承伤+15%"},
	{"类型": "道途", "关联": "法修", "效果": "法修范围AOE+12%"},
	{"类型": "道途", "关联": "御兽师", "效果": "御兽协同战力+10%"},
	{"类型": "道途", "关联": "符箓师", "效果": "符箓效果+15%"},
	{"类型": "道途", "关联": "毒师", "效果": "毒伤+15%"},
	{"类型": "道途", "关联": "傀儡师", "效果": "傀儡战力+12%"},
]
...
var 天赋类型 := ""
var 天赋关联 := ""
var beast_type := "attack"   # S1 P0：灵兽类型 attack/defense/support，决定道途适配加成
