...
"""
UI样式统一配置
定义字体大小、颜色、间距、圆角等常量，供所有UI页面使用
"""

# 创建UI样式配置文件
ui_style_content = '''extends RefCounted
class_name UIStyle
...
# 写入文件
file_path = r"E:\Xiuxian\taixuanzongmenlu\ui\ui_style.gd"
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(ui_style_content)

print("✅ UI样式统一配置文件创建成功：ui_style.gd")
print("\n📋 配置内容：")
print("  1. 字体大小统一配置（5级：标题/副标题/正文/小字/极小）")
print("  2. 颜色统一配置（14种常用颜色）")
print("  3. 间距统一配置（5级：超小/小/中/大/超大）")
print("  4. 圆角统一配置（4级：小/中/大/超大）")
print("  5. 阴影统一配置（3级：小/中/大）")
print("  6. 动画时长统一配置（3级：快/中/慢）")
print("\n🔧 工具函数：")
print("  1. create_button() - 创建统一风格的按钮")
print("  2. create_label() - 创建统一风格的标签")
print("  3. create_card() - 创建统一风格的卡片面板")
print("  4. apply_unified_font() - 应用统一字体大小到节点及其子节点")
print("  5. add_button_feedback() - 添加按钮点击反馈（缩放效果）")
print("\n📝 使用方法：")
print("  在UI脚本中：const UIStyle = preload('res://ui/ui_style.gd')")
print("  然后使用 UIStyle.FONT_SIZE_BODY、UIStyle.create_button() 等")
